...
| Matsu Water | Not implemented | Planned | Not evaluated | Coverage record only |

“Implemented” means the documented base formula exists. It does not mean every local surcharge, discount, adjustment, or account type is supported.
